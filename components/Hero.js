...
import {deleteMovieOfTheList} from '../firebase/endpoints/users'
...
const Hero = ({ myList, id, genres, type='movie' }) => {
	...
	const loadingFunction = {
		loading:loading,
		loadingChange:()=>setLoading(!loading)
	}
			...
			<MenuHero>
				{
					...
					(
						<Button activeOpacity={0.5} onPress={() => {
							deleteMovieOfTheList(loadingFunction.loadingChange, user,"58BjRBKyy7Ld6eIVSZ2M")
						}}>
